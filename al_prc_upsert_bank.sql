CREATE OR REPLACE PROCEDURE al_prc_upsert_bank(p_bank_name VARCHAR2,
...
BEGIN
    ...
    MERGE INTO al_bank b
        ...
        WHEN NOT MATCHED THEN 
            INSERT 
            (bank_name, account_number,sort_code, account_moniker, account_type)
            VALUES
            (p_bank_name, p_account_number, p_sort_code, p_account_moniker, p_account_type)
        WHEN MATCHED THEN
